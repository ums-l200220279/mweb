...
import { Brain, Info, ArrowRight, Clock, Trophy, BarChart3 } from "lucide-react"
import Link from "next/link"
import DividedAttentionGame from "@/components/games/divided-attention-game"
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mb-8 gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-purple-600 dark:text-purple-400">Attention Training</span>
          </div>
          <h1 className="text-3xl font-bold tracking-tight">Divided Attention Challenge</h1>
          <p className="text-muted-foreground max-w-2xl">
            Train your ability to monitor and respond to multiple stimuli simultaneously, a critical skill for everyday
            multitasking.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">Approx. 5 minutes</span>
              </div>
              <div className="flex items-center gap-2">
                <Brain className="h-4 w-4 text-muted-foreground" />
                <span className="text-sm text-muted-foreground">Attention, Processing Speed</span>
              </div>
            </div>
            <Button>
              Start Game
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="border border-border rounded-lg p-4 cursor-pointer bg-muted/20">
                    ...
                    <p className="text-sm text-muted-foreground">Balance visual and auditory stimuli</p>
                  </div>
                  <div className="border border-border rounded-lg p-4 cursor-pointer">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-medium">Visual Focus</h3>
                      <div className="w-4 h-4 rounded-full border border-border"></div>
                    </div>
                    <p className="text-sm text-muted-foreground">Emphasize visual attention tasks</p>
                  </div>
                  <div className="border border-border rounded-lg p-4 cursor-pointer">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-medium">Auditory Focus</h3>
                      <div className="w-4 h-4 rounded-full border border-border"></div>
                    </div>
                    <p className="text-sm text-muted-foreground">Emphasize auditory attention tasks</p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-muted/30 rounded-lg p-4 text-center">
                  ...
                  <p className="text-2xl font-bold">452ms</p>
              ...
              <div className="space-y-2">
                ...
                <div className="h-64 bg-muted/30 rounded-lg flex items-center justify-center">
                  ...
                  <p className="ml-2 text-muted-foreground">Performance chart would render here</p>
                </div>
              </div>
                  ...
                  {recentSessions.map((session, index) => (
                    <div key={index} className="flex items-center justify-between p-4">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Difficulty: {session.difficulty}</p>
                      </div>
                      <div className="text-right">
                        <p className="font-medium">{session.score} points</p>
