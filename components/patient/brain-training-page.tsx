  ...
  return (
    <div className="container py-6 space-y-8">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Brain Training Exercises</h1>
          <p className="text-muted-foreground">Train your brain with fun, scientifically-designed games</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-2">
          ...
          <CardFooter>
            <Button variant="outline" className="w-full" asChild>
              <Link href="/patient/brain-training/performance">
        ...
        <Card>
          ...
          <CardFooter>
            <Button variant="outline" className="w-full" asChild>
              <Link href="/patient/brain-training/achievements">
        ...
        <Tabs defaultValue="all" onValueChange={setSelectedCategory}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/patient/brain-training/favorites">My Favorites</Link>
            </Button>
          </div>
                  ...
                  >
                    <Card className="overflow-hidden h-full flex flex-col transition-all duration-200 hover:shadow-md">
                      <div className="relative h-40 w-full">
                        ...
                        {game.popular && <Badge className="absolute right-2 top-2">Popular</Badge>}
                      </div>
                      <CardHeader className="pb-2">
                      ...
                      <CardFooter>
                        <Button className="w-full" asChild>
                          <Link href={`/patient/brain-training/${game.id}`}>Play Now</Link>
                        </Button>
                      </CardFooter>
                    </Card>
                  </motion.div>
